module.exports = {
    ...
    "@arkecosystem/core-p2p": {
        ...
        port: process.env.CORE_P2P_PORT || 5501,
    },
    ...
    "@arkecosystem/core-api": {
        ...
        port: process.env.CORE_API_PORT || 5502,
        whitelist: ["*"],
    },
    "@arkecosystem/core-webhooks": {
        ...
        server: {
            ...
            port: process.env.CORE_WEBHOOKS_PORT || 5503,
    ...
    "@arkecosystem/core-graphql": {
        ...
        port: process.env.CORE_GRAPHQL_PORT || 5504,
    },
    "@arkecosystem/core-forger": {
        hosts: [`http://127.0.0.1:${process.env.CORE_P2P_PORT || 5501}`],
    },
